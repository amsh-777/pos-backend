...
// ================= TABLE BOOKING (with booking_date and booking_time) ================= 
  ...
  try { 
    ...
    const result = await pool.query( 
      ...
      `INSERT INTO table_booking  
        ...
        (customer_name, phone_number, table_number, start_time, end_time, booking_date, booking_time, status, note, people) 
